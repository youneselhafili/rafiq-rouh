    ...
    const commandsAtoN = new EmbedBuilder()
        ...
        .addFields(
            ...
            },
            {
                ...
                value: 'إعداد ختمة يومية: أسبوع، شهر، 3 أو 6 أشهر، رمضان، أو عدد صفحات مخصص. تُرسل أول دفعة فور الحفظ ثم يومياً في 08:00 بتوقيت مكة. رتبة المنشن تُحدد من `/setup_roles`، وبدونها لا يوجد منشن.',
            },
        );
