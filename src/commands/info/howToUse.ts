    ...
    const commandsAtoN = new EmbedBuilder()
        ...
        .addFields(
            ...
            },
            {
                ...
                value: 'إعداد ختمة يومية: أسبوع، شهر، 3 أو 6 أشهر، رمضان، أو عدد صفحات مخصص. عند التفعيل والحفظ تُرسل أول دفعة فوراً، ثم يكمل البوت يومياً في 08:00 بتوقيت مكة.',
            },
        );
    ...
    const setupCommands = new EmbedBuilder()
        ...
        .addFields(
            ...
            },
            {
                ...
                value: 'ربط رتب المنشن الخاصة بالأذان والأذكار والصلاة على النبي ﷺ والجمعة.',
            },
            {
