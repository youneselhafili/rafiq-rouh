...
export async function execute(interaction: ChatInputCommandInteraction) {
    ...
    const session: JumuahSetupSession = {
        ...
        channelId: existing?.channelId || adhkar?.generalChannelId,
...
export function buildJumuahSetupPayload(session: JumuahSetupSession) {
    ...
    const embed = new EmbedBuilder()
        ...
        .setDescription(
            '\u0643\u0644 \u062c\u0645\u0639\u0629 \u064a\u0631\u0633\u0644 \u0627\u0644\u0628\u0648\u062a \u0628\u0637\u0627\u0642\u0629 \u0633\u0648\u0631\u0629 \u0627\u0644\u0643\u0647\u0641 \u0641\u064a **\u0627\u0644\u0642\u0646\u0627\u0629 \u0627\u0644\u062a\u064a \u062a\u062e\u062a\u0627\u0631\u0647\u0627**. ' +
        ...
        .addFields(
            ...
            { name: '\u0642\u0646\u0627\u0629 \u0627\u0644\u0625\u0631\u0633\u0627\u0644', value: session.channelId ? `<#${session.channelId}>` : '\u274C \u0627\u062e\u062a\u0631 \u0642\u0646\u0627\u0629 \u0627\u0644\u0625\u0631\u0633\u0627\u0644', inline: true },
    ...
    const channel = new ActionRowBuilder<ChannelSelectMenuBuilder>().addComponents(
        new ChannelSelectMenuBuilder().setCustomId('jumuah_setup_channel').setPlaceholder('اختر قناة إرسال الجمعة').addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement),
    );
    ...
    return { embeds: [embed], components: [channel, primary, secondary] };
}
