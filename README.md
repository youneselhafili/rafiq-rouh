...
استعمل `/nakhtim`، اختر نوع الختمة والقناة أو DM، ثم فعّلها واحفظ. زر **معاينة صفحة القرآن** يعرض الصفحة الحالية بدون تغيير التقدم. في الوضع الرمضاني يمكن تحديد عدد الختمات.
